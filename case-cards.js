...
(function(){
  ...
  var CSS=[
    ...
    ".ps-cc-ic.ps-ic-build{background:var(--ps-accent-tint,#edf4ff) !important;color:var(--ps-accent-hover,#486798) !important;}",
    ...
    ".ps-f-cabinet{background:var(--ps-accent-tint,#edf4ff) !important;color:var(--ps-accent-hover,#486798) !important;}",
    ...
    ".ps-cc-link:hover{color:var(--ps-accent-hover,#486798) !important;}",
    ...
    "@media(max-width:820px){#pageContent .cards-grandpa > .lw-cols.multiple-rows{grid-template-columns:1fr !important;}#pageContent h1.learnworlds-heading{font-size:var(--ps-mob-h1,36px) !important;}#pageContent h2.learnworlds-subheading{font-size:27px !important;}.ps-tw{white-space:normal !important;}#pageContent .ps-desc{padding-right:0 !important;}}"
  ].join("\n");
